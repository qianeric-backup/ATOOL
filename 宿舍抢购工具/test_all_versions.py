...
"""
所有版本大规模测试脚本
包含V0.0.9, v1.1.0, v1.2.4, v1.2.6版本
"""
import sys
import os
import time
...
def run_all_versions_test():
    """运行所有版本测试"""
    print("所有版本大规模测试（每个版本20次）")
    print("="*80)
    ...
    # 保存详细结果
    report_file = f"所有版本测试报告_{time.strftime('%Y%m%d_%H%M%S')}.json"
